...
public class Java8Employee {
    public static void main(String[] args) {
        ...
        Map<Boolean, List<Employee1>> partitionEmployeesByAge = empList.stream()
        ...
        Map.Entry<String, Long> maxNoOfEmployeesInDept = empList.stream()
                .collect(Collectors.groupingBy(Employee1::getDeptName, Collectors.counting())).entrySet().stream()
        ...
        empList.stream().collect(Collectors.groupingBy(Employee1::getDeptName, Collectors.counting())).entrySet()
        ...
        Optional<Employee1> seniorEmp = empList.stream()
                .sorted(Comparator
                        .comparingInt(Employee1::getYearOfJoining))
                .findFirst();
        ...
        empList.stream().sorted(Comparator.comparingLong(Employee1::getSalary).reversed()).toList()
                .forEach(System.out::println);
        ...
        Map<String, Stream<Employee1>> sortedEmployeeAsc = empList.stream()
        ...
        Map<String, Stream<Employee1>> sortedEmployeeDesc = empList.stream()
                .collect(Collectors.groupingBy(Employee1::getDeptName, Collectors.collectingAndThen(Collectors.toList(),
        ...
        System.out.println("Highest second salary dept wise:: \n" + empList.stream()
                .collect(Collectors.groupingBy(Employee1::getDeptName,
                        Collectors.collectingAndThen(Collectors.toList(),
                                list3 -> list3.stream()
                                        .sorted(Comparator.comparingDouble(Employee1::getSalary).reversed()).skip(1)
                                        .findFirst()))));


    List<Employee1> empList1 = new ArrayList<Employee1>();

    empList1.add(new Employee1(1, "abc", 28, 123, "F", "HR", "Blore", 2020));
    empList1.add(new Employee1(2, "xyz", 29, 120, "F", "HR", "Hyderabad", 2015));
    empList1.add(new Employee1(3, "efg", 30, 115, "M", "HR", "Chennai", 2014));
    empList1.add(new Employee1(4, "def", 32, 125, "F", "HR", "Chennai", 2013));
    empList1.add(new Employee1(5, "pqr", 33, 130, "M", "HR", "Blore", 2018));
    empList1.add(new Employee1(6, "stu", 34, 135, "M", "Finance", "Bengaluru", 2017));

    System.out.println("*** Employee List ***");
    Employee1[] empArray = empList1.toArray((e) -> new  Employee1[e]);
    Stream.of(empArray).forEach((p) -> System.out.println(p));
    System.out.println("*** With Method Reference ***");
    Employee1[] empArray1 = empList1.toArray(Employee1[]::new);
